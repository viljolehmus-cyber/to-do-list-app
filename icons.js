/* ==========================================================================
   icons.js — single source of truth for all icons in the app.

   One consistent line-art family (Lucide-style): 24x24 viewBox, single
   stroke weight, round caps/joins. Icons are embedded inline so the app
   works fully offline (no CDN requests).

   Usage:  import { icon } from './icons.js';
           el.innerHTML = icon('plus');             // default 24px
           el.innerHTML = icon('bell', { size: 20, cls: 'muted' });
   ========================================================================== */
...
export function icon(name, opts = {}) {
  const { size = 24, cls = '', strokeWidth = 2 } = opts;
...
/** List of available icon names (handy for debugging / future pickers). */
